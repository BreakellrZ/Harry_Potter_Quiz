...
<details>
<summary> Header Feature </summary>
...
<details>
<summary> Main div Feature </summary>
...
<details>
<summary> Rules Area Features </summary>
...
<details>
<summary> Game Area Features </summary>
...
- At first I wanted to create a Quiz, my repository is called Harry_Potter_Quiz. During development I changed my mind and I thought a spell game would be cooler. I did not change the GitHub repository name as I was told it may cause some problems. I will change this after my project has been graded to a more suitable name.

- Lastly, one thing I noticed was when the user finishes the game, The scores both reset to 0 in the back-end, which is what is intended but the losers score does not show up as "0 in the front-end", It stays on the losers previous games score until they win a round and then it will show up as "Dracos/Users score is 1" which is correct because both have been reset to 0 after the previous game finished and Draco/User won a round, but I am trying to fix it so both Draco and the User are both reset to 0 on the front end after each game. The game still runs as intended and this does not interfere with the fundamentals of the game.! This took me a while to figure out but with the help of student support I figured out how to fix this bug. This was very rewarding to me. [Game challenge](documentation/game_challenge.png) ![Game challenge](documentation/game_challenge2.png)
